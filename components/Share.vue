<template>
  <section>
    <a @click="openModal" :href="facebookShareUrl" target="_blank" rel="noopener noreferrer">Facebook</a>
    <a @click="openModal" :href="TwitterShareUrl" target="_blank" rel="noopener noreferrer">Twitter</a>
    <a @click="openModal" :href="LinkedinShareUrl" target="_blank" rel="noopener noreferrer">Linkedin</a>
  </section>
</template>
